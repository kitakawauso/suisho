...
const outputVideo = document.getElementsByClassName('output_video')[0];
...
function onResults(results) {
  ...
  canvasCtx.drawImage( // TODO: 最初から動画は表示したい
...
function recording(card, sum) { // XXX: めのときに挙動がおかしい
...
function chanting() {
  ...
  chant.addEventListener("timeupdate", function(){
